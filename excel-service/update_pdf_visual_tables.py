...
# Find the end of export_pdf_visual
...
new_func = """def export_pdf_visual(data_dict, output_path, metadata):
    ...
    DB_TO_INTERNAL_RKA_MAP = {
        ...
        'Pinjaman Small': 'pinjaman small',
        'Pinjaman Konsumer': 'pinjaman konsumer',
        'SML': 'sml',
        'SML Ratio': 'sml %',
        'NPL': 'npl',
        'NPL Ratio': 'npl %',
    ...
    for rka in rka_payload:
        ...
        bulan_str = str(rka.get('bulan', '')).lower()
    ...
    for kc_nm in kcs:
        ...
        cols_count = len(periode_list) + 5
        det_data = []
        
        header_row = ["Mata Anggaran"] + periode_list + ["RKA", "Pencp RKA %", "MTD", "YTD", "YOY"]
